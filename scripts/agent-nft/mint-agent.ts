...
const DefaultMetadata: Metadata = {
  ...
  description:
    'Aurora is an intelligent multi-domain assistant designed to help users manage tasks, perform quick research, and interact with Web3 services seamlessly.',
  avatar: 'https://example.com/aurora.png',
  externalUrl: 'https://example.com/aurora',
  version: '2.1.0',
  model: 'gpt-5-mini',
  personality:
    'Calm, informative, and slightly humorous. Enjoys making conversations engaging while staying concise.',
  capabilities: [
    {
      name: 'TextGeneration',
